...
function getEpisodes(sTitle) {
	...
	var sBanner = document.createElement("DIV");
		...
		var bBtn = document.createElement("BUTTON");
			bBtn.setAttribute("onclick", "window.open('anime.html','_self')");
			bBtn.innerHTML = "Back to Anime List"
...
function storeData(mTitle) {
	...
	if (dbLst.length > 3000) {
		var tt = mTitle.split("--");
		var dd = dbLst.split("-i-");
		var dbNew = "-i-";
		var dmin = dd.indexOf(tt[1]) - 20;
		var dmax = dd.indexOf(tt[1]) + 20;
	...
	document.cookie = "mData2" + "=" + mTitle + "--anime";
